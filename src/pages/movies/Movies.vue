  ...
  <div class="m-movie">
    <div class="white-bg topbar-bg">
      <div class="city-entry">
        ...
        <svg t="1541208993260" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2028"
      ...
      <div class="search-entry">
        <svg t="1541209876271" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2872"
...
export default {
  ...
  mounted () {
    console.log('keep-alive生命周期失效，只会触发第一次', this.$store.state.city)
  },
  activated () {
    console.log('keep-alive有效钩子', this.$store.state.city)
  ...
  .topbar-bg
    ...
    .switch-hot
      ...
      .hot-item
        ...
        &.active
          color $base-color
          border-bottom solid 0.02rem $base-color
    .search-entry
      flex 80
      display flex
